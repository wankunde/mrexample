...
public class SequenceFileDemo {
    ...
    public void readSequenceFile() throws IOException {
        ...
        // another way
//        InputSplit split = new FileSplit(src, 0, status.getLen(), (String[]) null);
//        RecordReader<Text, Text> reader = new SequenceFileRecordReader<>();
//        reader.initialize(split, new TaskAttemptContextImpl(conf, new TaskAttemptID(new TaskID(), 0)));
//        while (reader.nextKeyValue()) {
//            System.out.println("kv : " + reader.getCurrentKey() + ":" + reader.getCurrentValue());
//        }
